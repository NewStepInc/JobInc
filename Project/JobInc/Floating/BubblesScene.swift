...
//        backgroundColor = SKColor.whiteColor()
        backgroundColor = SKColor.init(red: 59.0/255.0, green: 139.0/255.0, blue: 169.0/255.0, alpha: 1.0)
    ...
    func sortedFloatingNodes() -> [SIFloatingNode]! {
        var sortedNodes = floatingNodes.sort { (node: SIFloatingNode, nextNode: SIFloatingNode) -> Bool in
